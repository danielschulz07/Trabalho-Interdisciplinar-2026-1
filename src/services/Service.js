...
var consumoAPI_1 = require("../models/consumoAPI");
var Bioma_1 = require("../models/Bioma");
var Repository_1 = require("../repositories/Repository");
var MobPassivo_1 = require("../models/MobPassivo");
var MobHostil_1 = require("../models/MobHostil");
var Service = /** @class */ (function () {
    function Service() {
    }
    Service.carregarBiomas = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        vetBiomas = [];
                        return [4 /*yield*/, consumoAPI_1.consumoAPI.consultaBioma("")];
                    case 1:
                        dados = _a.sent();
                        dados.data.forEach(function (bioma) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        vetMobs = [];
                        return [4 /*yield*/, consumoAPI_1.consumoAPI.consultaMob("")];
                    case 1:
                        dados = _a.sent();
                        dados.data.forEach(function (mobs) {
